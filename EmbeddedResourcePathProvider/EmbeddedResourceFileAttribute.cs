...
namespace Paraesthesia.Web.Hosting
{
	...
	/// served by the <see cref="Paraesthesia.Web.Hosting.EmbeddedResourcePathProvider"/>.
	/// </summary>
	/// <remarks>
	/// <para>
	/// This attribute is used by the <see cref="Paraesthesia.Web.Hosting.EmbeddedResourcePathProvider"/>
	...
	/// user control in an assembly to be served up with the <see cref="Paraesthesia.Web.Hosting.EmbeddedResourcePathProvider"/>:
	/// </para>
	/// <code lang="C#">
	...
	public sealed class EmbeddedResourceFileAttribute : Attribute
	{
		...
		/// <seealso cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute.RemoveMalformedEndChars" />
		...
		/// <see cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute.ResourceNamespace" />
		/// property.
		/// </summary>
		/// <seealso cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute" />
		...
		/// <summary>
		/// Internal storage for the
		/// <see cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute.ResourcePath" />
		/// property.
		/// </summary>
		/// <seealso cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute" />
		...
		/// <remarks>
		/// <para>
		/// This namespace will be removed from the full <see cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute.ResourcePath"/>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Paraesthesia.Web.Hosting.EmbeddedResourceFileAttribute" /> class.
		/// </summary>
		...
		/// (which will be converted by the <see cref="Paraesthesia.Web.Hosting.EmbeddedResourcePathProvider"/>
